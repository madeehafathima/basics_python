  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <p class="style6">Post Created and Published Successfully.... </p>
	    <p>&nbsp;</p>
	    <p>&nbsp;</p>
...
<%
					...
					try {
						...
						PreparedStatement ps=connection.prepareStatement("insert into posts(user,pname,image,pdesc,year,date,rank) values(?,?,?,?,?,?,?)");
			...
			%>
			<p><a href="U_Create_Post.jsp">Back</a>         <a href="U_Main.jsp">Home</a> </p>
