  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <p>&nbsp;</p>
	    <p class="style7">VIEW ALL MY POSTS.....</p>
	    <p class="style7">&nbsp;</p>
	    <p class="style7">&nbsp;</p>
	...
	while ( rs.next() )
	{
		...
		%>
				...
				<tr>
				  <td  width="109" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Post Image </div></td>
				  <td  width="97" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Post Name</div></td>
				  <td   width="206" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Post Description</div></td>
				  <td   width="206" height="0" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Election Year</div></td>
				  <td  width="126" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Created Date &amp; Time </div></td>
			      <td  width="102" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style9">Prediction</div></td>
				</tr>
					<%}%>
				<tr>
	   	...
	   	<td width="109"><input  name="image" type="image" style="width:100px; height:100px;" src="profile_pic.jsp?id=<%=i%>&type=<%="post"%>"/></td>
			  ...
			  <td  width="102" height="110" align="center" valign="middle"><div align="center"><a href="U_View_All_Predictions.jsp?name=<%=s2%>&id=<%=i%>">View Predictions</a></div></td>
		</tr>
