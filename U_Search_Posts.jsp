  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <p class="style7">&nbsp;</p>
	    <p class="style7">&nbsp;</p>
	   <form name="s" action="U_Search_Posts1.jsp" method="post" onSubmit="return valid()"  ons target="_top">
            <table width="540">
              <tr>
                <td width="229" height="46" bgcolor="#FF0000"><strong>Enter Keyword or Post Name </strong></td>
                <td width="171"><input type="text" name="pname" /></td>
                <td width="124"><label>
